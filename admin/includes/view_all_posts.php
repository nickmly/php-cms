                ...
                while($row = mysqli_fetch_assoc($posts)) {
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            echo "<td><img class='img-fluid' src='../images/" . $row['post_image'] . "'></td>";
                            echo "<td>" . $row['post_tags'] . "</td>";
                            echo "<td>" . $row['post_comment_count'] . "</td>";
                        ?>
                        <td>
                            <a class="btn-sm btn-warning" href="?source=edit&update_post=<?php echo $row['post_id']; ?>">Edit</a>
                        </td>
                        <td>
                            <a onclick="return confirmAction()" class="btn-sm btn-danger" href="?delete_post=<?php echo $row['post_id']; ?>">Delete</a>
                        </td>
                    </tr>                                        
                    <?php
                }
